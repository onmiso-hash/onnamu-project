...
## 📅 주요 히스토리
- 2026-06-03: Chronicle Studio 로그인 기능 추가 및 Media Home 통합(SSO) 연동 완료 (공통 서명 토큰 auth_token 발행/검증, 연동 로그아웃 및 UI 컴포넌트 추가). 상세 내용은 `history/STUDIO_LOGIN_INTEGRATION_20260603.md` 참조.
