...
| **`namu-cloud-routing`** | `namu-cloud-routing:v0.1.4` (clone --recurse-submodules 로컬 빌드) | `0.0.0.0:8770` | `8770` | NAMU 공용 라우팅 MCP 서버 (`?user=<키>` per-user 격리, `namu_cloud_store` 볼륨에 STORE clone 영속화) |
